...
const showCard = () => {
    cash_dom__WEBPACK_IMPORTED_MODULE_0___default()('.menu-auth').toggleClass('active');
    cash_dom__WEBPACK_IMPORTED_MODULE_0___default()('.menu-card').toggleClass('active');
};

cash_dom__WEBPACK_IMPORTED_MODULE_0___default()('.menu-toggle').on('click', showCard);
cash_dom__WEBPACK_IMPORTED_MODULE_0___default()('.menu-user .img').on('click', showCard);
...
/* harmony import */ var _events_menu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./events/menu */ "./assets/js/events/menu.js");
